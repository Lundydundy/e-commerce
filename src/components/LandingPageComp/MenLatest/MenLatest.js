...
import men2 from "../../../static/images/men-02.jpg"
import men3 from "../../../static/images/men-03.jpg"
import men4 from "../../../static/images/men-04.jpg"
                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="section-heading">
                            <h2>Men's Latest</h2>
                            <span>The best clothing for the modern man.</span>
                        </div>
                    </div>
                </div>
            </div>
